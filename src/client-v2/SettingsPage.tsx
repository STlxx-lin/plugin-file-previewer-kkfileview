...
export const SettingsPage = () => {
    ...
    const handleSave = async () => {
        try {
            ...
            const fileViewerPayload = buildFileViewerSaveState(
                {
                    enableFileViewer: values.enableFileViewer === true,
                    fileViewerAssetBase: values.fileViewerAssetBase,
                    fileViewerExtensions: values.fileViewerExtensions,
                },
                {
                    enableFileViewer: false,
                    fileViewerAssetBase: DEFAULT_FILE_VIEWER_ASSET_BASE,
    ...
    const handleValuesChange = (changedValues: Partial<SettingsFormValues>, allValues: SettingsFormValues) => {
        ...
        if (
            ...
            || Object.prototype.hasOwnProperty.call(changedValues, 'enableFileViewer')
